     ...
     private void aboutSpeechTypingToolStripMenuItem_Click(object sender, EventArgs e)
        ...
        private void selectAllToolStripMenuItem_Click(object sender, EventArgs e)
        {
           ...
           ArrayList outarrlist = new ArrayList();
            ...
            {
                if (System.Text.RegularExpressions.Regex.IsMatch(strSyllable, p[0].ToString(), System.Text.RegularExpressions.RegexOptions.IgnoreCase))
                {
            ...
            foreach (string str in syllableArr)
            {
                if(punq.Contains(str))
                {
                 ...
                 try 
                 {
                     ...
                     System.Text.RegularExpressions.Match matchcase = Regex.Match(str.Trim(), @"([၀-၉])", RegexOptions.IgnoreCase);
